...
/**
 * This class is responsible for reacting on file Message download request
 * on the server side
 * 
 * @author Jyoti
 *
...
public class download extends Thread{ 
    ...
    private String path; 
    /*
     * Open a port to receive file download requests
     */
    public void run() {  
        try { 
            ServerSocket serverSocket = new ServerSocket(Constants.DOWNLOADPORT);  
            while (true) {  
            	this.sent=0;
